...
if __name__ == "__main__":
    ...
    ent_dir = os.path.join(Config.BASE_DIR, "data", "enterprise_clean_data")
    start_dir = os.path.join(Config.BASE_DIR, "data", "startup_messy_data")
    ...
    ent_db = sqlite3.connect(Config.VISTASTREAM_DB_PATH)
    ...
    start_db = sqlite3.connect(Config.NEONPLAY_DB_PATH)
