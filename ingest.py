...
import os
import sys
from csv_loader import run_ingestion
...
def run_env(env):
    ...
    if env == "enterprise":
        ...
        db_path = os.path.join(base_dir, "databases", "vistastream.db")
        data_dir = os.path.join(base_dir, "enterprise_clean_data")
        dataset = "vistastream"
    elif env == "startup":
        env_name = "NeonPlay Media"
        db_path = os.path.join(base_dir, "databases", "neonplay.db")
        data_dir = os.path.join(base_dir, "startup_messy_data")
        dataset = "neonplay"
    else:
